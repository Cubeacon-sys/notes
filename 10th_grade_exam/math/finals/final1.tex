...
\begin{enumerate}[itemsep=2ex]
    % 1. Eksponen
    \item Bentuk sederhana dari $\displaystyle \frac{(a^3 b^2)^2}{a^4 b^3}$ adalah \dots
    \begin{multicols}{2}
    ...
    % 2. Logaritma
    \item Nilai dari ${}^3\log 27 + {}^2\log 4 - {}^7\log 1$ adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $2$
        \item $3$
    ...
    % 3. SPLDV
    \item Diketahui sistem persamaan linear dua variabel $3x + y = 8$ dan $x - y = 4$. Nilai dari $x - 2y$ adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $3$
        \item $4$
    ...
    \item Penyelesaian dari persamaan linear $2(3x - 2) = 4x + 6$ adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $x = 2$
        \item $x = 3$
    ...
    % 7. Sumbu simetri
    \item Sumbu simetri dari grafik fungsi kuadrat $f(x) = x^2 - 8x + 12$ adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $x = -8$
        \item $x = -4$
    ...
    % Kurva parabola
    \addplot[thick, smooth, blue!80!black, domain=0.8:5.2] {x^2 - 6*x + 8};
    % Garis putus-putus ke titik puncak
    \addplot[dashed, thick, red!70!black] coordinates {(3,0) (3,-1) (0,-1)};
    % Titik puncak
    \filldraw[red!80!black] (3,-1) circle (2pt) node[anchor=north west, font=\footnotesize, text=red!80!black] {Titik Puncak};
    % Titik potong sumbu X
    \filldraw[blue!80!black] (2,0) circle (1.5pt);
    \filldraw[blue!80!black] (4,0) circle (1.5pt);
    \end{axis}
    \end{tikzpicture}
    \end{center}
    ...
    \begin{tikzpicture}[scale=0.9, >=stealth, line join=round]
        ...
        % Label Panjang Sisi
        \node[left, font=\bfseries, blue!80!black] at (0, 1.5) {$8$ cm};
    \end{tikzpicture}
    \end{center}
    Diketahui segitiga siku-siku di $B$ dengan $\angle A = 30^\circ$ dan panjang sisi $BC = 8$ cm. Panjang sisi $AC$ adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $4$ cm
        \item $8\sqrt{2}$ cm
    ...
    \begin{tikzpicture}[>=stealth]
        ...
        % Keterangan Jarak
        \draw[<->, thick] (0,-0.6) -- (5,-0.6) node[midway, fill=white, font=\footnotesize] {$15$ meter};
        \draw[dashed, gray] (0,0) -- (0,-0.8);
        \draw[dashed, gray] (5,0) -- (5,-0.8);
    \end{tikzpicture}
    \end{center}
    Jika jarak anak tersebut ke tiang bendera adalah 15 meter dan tinggi anak dari tanah ke mata diabaikan, tinggi tiang bendera tersebut adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $10$ m
        \item $15$ m
    ...
    % 13. Sudut depresi
    \item Dari atas sebuah gedung dengan ketinggian 90 meter, seseorang melihat sebuah mobil di jalan dengan sudut depresi $30^\circ$. Jarak mobil terhadap dasar gedung adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $30\sqrt{3}$ m
        \item $45\sqrt{3}$ m
    ...
    \item Dalam suatu data berkelompok, diketahui nilai jangkauan (range) data adalah 48 dan akan dibuat menjadi 8 kelas interval. Panjang interval kelas yang sesuai adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item 4
        \item 5
    ...
    \item Modus dari kumpulan data tunggal $7, 8, 9, 7, 8, 10, 7, 6, 9$ adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item 6
        \item 7
    ...
    % 20. Faktorial
    \item Nilai dari $\displaystyle \frac{8!}{6! \cdot 2!}$ adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item 14
        \item 28
    ...
    % 21. Permutasi
    \item Dari 7 orang siswa, akan dipilih seorang ketua, sekretaris, dan bendahara. Banyaknya susunan pengurus yang mungkin terbentuk adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item 35
        \item 120
    ...
    % 22. Titik sampel
    \item Banyaknya titik sampel pada pelemparan 5 keping uang logam secara bersamaan adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item 5
        \item 10
    ...
    % 23. Peluang (1)
    \item Peluang munculnya mata dadu kurang dari 5 pada pelemparan sebuah dadu adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $\frac{1}{6}$
        \item $\frac{1}{3}$
    ...
    % 24. Peluang (2)
    \item Tiga keping uang logam dilempar undi bersama-sama satu kali. Peluang munculnya paling sedikit satu Angka adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $\frac{1}{8}$
        \item $\frac{3}{8}$
    ...
    % 25. Peluang (3)
    \item Dua buah dadu dilemparkan secara bersamaan. Peluang munculnya jumlah kedua mata dadu sama dengan 9 adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $\frac{3}{36}$
        \item $\frac{4}{36}$
    ...
    % 26. Peluang (4)
    \item Di dalam sebuah kotak terdapat 5 bola merah dan 4 bola biru. Jika diambil 2 bola sekaligus secara acak, peluang terambilnya keduanya bola merah adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $\frac{2}{9}$
        \item $\frac{5}{18}$
    ...
    % 27. Peluang (5)
    \item Dari seperangkat kartu bridge (tanpa joker) diambil satu kartu secara acak. Peluang yang terambil adalah kartu bernomor 7 atau kartu bernomor 8 adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item $\frac{2}{52}$
        \item $\frac{4}{52}$
    ...
    \item Sebuah dadu dilemparkan sebanyak 180 kali. Frekuensi harapan munculnya mata dadu lebih dari 4 adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item 30 kali
        \item 45 kali
    ...
    % 29. Kombinasi (1)
    \item Dari 9 orang pelamar kerja, akan diterima 4 orang. Banyak cara memilih pelamar yang diterima adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item 63
        \item 84
    ...
    % 30. Kombinasi (2)
    \item Dalam sebuah pertemuan terdapat 12 orang yang saling berjabat tangan. Jika setiap orang hanya berjabat tangan tepat satu kali dengan orang lainnya, maka banyak jabat tangan yang terjadi adalah \dots
    \begin{multicols}{2}
    \begin{enumerate}[label=\Alph*.]
        \item 24
        \item 45
