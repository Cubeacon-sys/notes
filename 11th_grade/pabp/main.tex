...
\title{	\normalsize \textsc{\textit{``I am a scientist, I have to act on my own theory, I can't let my emotions get in the way''\\- Makise Kurisu} } 	% Subtitle
  \\[2.0cm]								% 2cm spacing
  \HRule{0.5pt} \\						% Upper rule
  \LARGE \textbf{\uppercase{PABP}}	% Title
