...
\title{	\normalsize \textsc{\textit{``Di atas dasar Pancasila, kita mendirikan negara Indonesia yang kekal dan abadi.''\\- Ir.Soekarno } } 	% Subtitle
		 	\\[2.0cm]								% 2cm spacing
			\HRule{0.5pt} \\						% Upper rule
			\LARGE \textbf{\uppercase{Tugas Kelompok Pendidikan Pancasila dan Kewarganegaraan}}	% Title
