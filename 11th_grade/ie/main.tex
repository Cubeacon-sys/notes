...
\title{	\normalsize \textsc{\textit{``Shut up! I stopped wearing teddie bear panties a few years ago!...Ah!'\\- Makise Kurisu} } 	% Subtitle
		 	\\[2.0cm]								% 2cm spacing
			\HRule{0.5pt} \\						% Upper rule
			\LARGE \textbf{\uppercase{Intensive English}}	% Title
