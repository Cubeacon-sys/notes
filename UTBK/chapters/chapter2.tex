...
\begin{multicols}{2}
  ...
  \item Setiap orang mempunyai mata untuk melihat. \\
    ...
    \item \textbf{Tidak dapat ditarik kesimpulan pasti mengenai mata A.}
    ...
    Berdasarkan aturan inferensi formal, susunan premis $p \implies q$ dan $q$ merupakan sesat pikir \textit{Affirming the Consequent}. Penglihatan terganggu tidak selalu disebabkan oleh mata sakit (bisa karena faktor lain). Oleh karena itu, tidak ada kesimpulan valid yang dapat diturunkan.
  ...
  \item Penyakit menular dapat ditularkan dari manusia ke manusia yang lain. \\
    ...
    \item \textbf{Jika Penyakit X menular, maka penyakit tersebut disebabkan oleh virus.}
    \end{enumerate}
    \textbf{Penjelasan: } \\
    Misal $M$: Penyakit menular, $V$: Disebabkan virus. \\
    Pernyataan: $\neg M \lor V$ \textit{(``Tidak menular ATAU disebabkan virus'')}. \\
    Berdasarkan hukum ekuivalensi logika (Ekuivalensi Implikasi), bentuk disjungsi $\neg p \lor q$ setara secara mutlak dengan $p \implies q$. Oleh karena itu, $\neg M \lor V \equiv M \implies V$ \textit{(``Jika Penyakit X menular, maka disebabkan oleh virus'')}. 
